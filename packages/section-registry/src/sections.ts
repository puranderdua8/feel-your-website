  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        helpText: "The id of a registered mutation action, e.g. newsletter.subscribe.",
      },
      {
        name: "body",
        label: "Request body",
        type: "actionBody",
        showWhen: { field: "mode", equals: "action" },
        helpText: "How each action input is filled — from a fixed value or a route param.",
      },
      {
        name: "successLabel",
        label: "Label after success",
        type: "text",
        showWhen: { field: "mode", equals: "action" },
      },
    ],
